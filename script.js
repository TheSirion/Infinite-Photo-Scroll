...
let apiUrl = `https://api.unsplash.com/photos/random/?client_id=${apiKey}&count=${requestCount}`;
...
const changeRequestCount = () => {
  if (initialRequest) {
    ...
    apiUrl = `https://api.unsplash.com/photos/random/?client_id=${apiKey}&count=${requestCount}`;
  }
};
